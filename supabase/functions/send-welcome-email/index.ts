...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { email, full_name }: WelcomeEmailRequest = requestBody;
    ...
    console.log('Using display name:', userName);
    ...
    console.log('Authorization header will use API key starting with:', sendGridApiKey.substring(0, 10) + '...');
    ...
    console.error('=== ERROR IN WELCOME EMAIL FUNCTION ===');
